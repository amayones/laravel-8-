...
<body>
    ...
    <div class="container mt-5 mb-5">
        <form action="<?php echo e(route('admin.ubahproduk', $produk->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <h3 class="text-center">Silahkan ubah data produk</h3>
            <hr>
            <div class="mb-3">
                <label for="" class="form-label">Nama Produk</label>
                <input type="text" name="name" class="form-control" value="<?php echo e($produk->name); ?>" required>
            </div>
...
<?php /**PATH C:\laragon\www\laravel8\resources\views/produk/ubah.blade.php ENDPATH**/ ?>